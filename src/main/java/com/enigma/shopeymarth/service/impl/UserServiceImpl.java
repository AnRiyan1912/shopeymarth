...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public AppUser loadUserByUserId(String id) {// method untuk memferivikasi jwt nya
    ...
    @Override
    public UserDetails loadUserByUsername(String username) { // Method ini untuk cek by username
